...
import litepal.tablemanager.typechange.BlobOrm;
import litepal.tablemanager.typechange.BooleanOrm;
import litepal.tablemanager.typechange.DateOrm;
import litepal.tablemanager.typechange.DecimalOrm;
import litepal.tablemanager.typechange.NumericOrm;
import litepal.tablemanager.typechange.OrmChange;
import litepal.tablemanager.typechange.TextOrm;
...
public abstract class LitePalBase {
     ...
     *
     * @param className The class name to introspection.
     * @param action    Between {@link litepal.LitePalBase#GET_ASSOCIATIONS_ACTION} and
     *                  {@link litepal.LitePalBase#GET_ASSOCIATION_INFO_ACTION}
     */
