...
/**
 * Configuration of LitePal database. It's similar to dbconfig.xml configuration, but allows to
...
public class LitePalDB {
    ...
    /**
     * Construct a LitePalDB instance from the default configuration by dbconfig.xml. But database
     * name must be different than the default.
     *
     * @param dbName Name of database.
     * @return A LitePalDB instance which used the default configuration in dbconfig.xml but with a specified database name.
     */
