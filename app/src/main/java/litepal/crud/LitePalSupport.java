...
public class LitePalSupport {
    ...
    public int delete() {
        synchronized (LitePalSupport.class) {
            ...
            db.beginTransaction();
            try {
                litepal.crud.DeleteHandler deleteHandler = new DeleteHandler(db);
    ...
    public int update(long id) {
        synchronized (LitePalSupport.class) {
            ...
            db.beginTransaction();
            try {
                litepal.crud.UpdateHandler updateHandler = new litepal.crud.UpdateHandler(Connector.getDatabase());
    ...
    public int updateAll(String... conditions) {
        synchronized (LitePalSupport.class) {
            ...
            db.beginTransaction();
            try {
                litepal.crud.UpdateHandler updateHandler = new UpdateHandler(Connector.getDatabase());
    ...
    public void saveThrows() {
        synchronized (LitePalSupport.class) {
            ...
            db.beginTransaction();
            try {
                litepal.crud.SaveHandler saveHandler = new litepal.crud.SaveHandler(db);
            ...
            if (list.isEmpty()) {
                ...
                try {
                    for (LitePalSupport support : list) {
                        ...
                        litepal.crud.SaveHandler saveHandler = new SaveHandler(db);
                        saveHandler.onSave(this);
                        clearAssociatedData();
                    }
                    db.setTransactionSuccessful();
