 ...
 * @since 1.1
 */
public class Many2ManyAnalyzer extends litepal.crud.AssociationsAnalyzer {
     ...
     * {@link litepal.crud.LitePalSupport#addAssociatedModelForJoinTable(String, long)} will be called
    ...
    void analyze(litepal.crud.LitePalSupport baseObj, AssociationsInfo associationInfo) throws SecurityException,
        ...
        Collection<litepal.crud.LitePalSupport> associatedModels = getAssociatedModels(baseObj, associationInfo);
        declareAssociations(baseObj, associationInfo);
        if (associatedModels != null) {
            for (litepal.crud.LitePalSupport associatedModel : associatedModels) {
                Collection<litepal.crud.LitePalSupport> tempCollection = getReverseAssociatedModels(
                        associatedModel, associationInfo);
                Collection<litepal.crud.LitePalSupport> reverseAssociatedModels = checkAssociatedModelCollection(
    ...
    /**
     * This add an empty set for {@link litepal.crud.LitePalSupport#associatedModelsMapForJoinTable}.
     * Might use for updating intermediate join table.
     *
     * @param baseObj         The baseObj currently want to persist or update.
     * @param associationInfo To get associated table name from.
     */
    private void declareAssociations(litepal.crud.LitePalSupport baseObj, AssociationsInfo associationInfo) {
     ...
     * @param baseObj                   The baseObj currently want to persist or update.
     */
    private void addNewModelForAssociatedModel(Collection<litepal.crud.LitePalSupport> associatedModelCollection,
                                               litepal.crud.LitePalSupport baseObj) {
     ...
     * {@link litepal.crud.LitePalSupport#associatedModelsMapForJoinTable} for
    ...
    @Deprecated
    private boolean isDataExists(litepal.crud.LitePalSupport baseObj, litepal.crud.LitePalSupport associatedModel) {
     ...
     */
    private String getSelection(litepal.crud.LitePalSupport baseObj, litepal.crud.LitePalSupport associatedModel) {
     ...
     */
    private String[] getSelectionArgs(litepal.crud.LitePalSupport baseObj, litepal.crud.LitePalSupport associatedModel) {
     ...
     */
    private String getJoinTableName(litepal.crud.LitePalSupport baseObj, LitePalSupport associatedModel) {
