 ...
 * @since 1.1
 */
class Many2OneAnalyzer extends litepal.crud.AssociationsAnalyzer {
     ...
     * and calling
     * {@link #dealAssociatedModelOnManySide(Collection, litepal.crud.LitePalSupport, litepal.crud.LitePalSupport)}
     * to set foreign key.
     *
     ...
     * @throws InvocationTargetException
     */
    private void analyzeManySide(litepal.crud.LitePalSupport baseObj, AssociationsInfo associationInfo)
        ...
        if (associatedModel != null) {
            ...
            Collection<litepal.crud.LitePalSupport> tempCollection = getReverseAssociatedModels(associatedModel,
                    associationInfo);
     ...
     * {@link #buildBidirectionalAssociations(litepal.crud.LitePalSupport, litepal.crud.LitePalSupport, AssociationsInfo)}
     * to build bidirectional association if they haven't built yet. Then calls
     * {@link #dealAssociatedModelOnOneSide(litepal.crud.LitePalSupport, litepal.crud.LitePalSupport)} to set
     * foreign key.
     *
     * @param baseObj         The baseObj currently want to persist.
     * @param associationInfo The associated info analyzed by
     ...
     * @throws InvocationTargetException
     */
    private void analyzeOneSide(litepal.crud.LitePalSupport baseObj, AssociationsInfo associationInfo)
            throws SecurityException, IllegalArgumentException, NoSuchMethodException,
            IllegalAccessException, InvocationTargetException {
     ...
     * {@link litepal.crud.LitePalSupport#addAssociatedModelWithFK(String, long)}.
     *
     ...
     *                         {@link LitePalBase#getAssociationInfo(String)}.
     */
    private void dealAssociatedModelOnManySide(Collection<litepal.crud.LitePalSupport> associatedModels,
                                               litepal.crud.LitePalSupport baseObj, litepal.crud.LitePalSupport associatedModel) {
     ...
     *                        {@link LitePalBase#getAssociationInfo(String)}.
     */
    private void dealAssociatedModelOnOneSide(litepal.crud.LitePalSupport baseObj, LitePalSupport associatedModel) {
