 ...
 * @since 1.1
 */
public class SaveHandler extends litepal.crud.DataHandler {

    private ContentValues values;

    /**
     * Initialize {@link litepal.crud.DataHandler#mDatabase} for operating database. Do not
     ...
     * {@link litepal.Operator#saveAll(Collection)}. Each model in the collection
    ...
    private void giveModelIdValue(LitePalSupport baseObj, String idName, Class<?> idType, long id)
        ...
        if (shouldGiveModelIdValue(idName, idType, id)) {
            ...
            litepal.crud.DynamicExecutor.setField(baseObj, idName, value, baseObj.getClass());
        }
    }
