...
/**
 * Reading the attributes in the dbconfig.xml file. Check all the attributes if they
...
public class InvalidAttributesException extends RuntimeException {
    ...
    /**
     * dbname is empty or not defined in dbconfig.xml file.
     */
    public static final String DBNAME_IS_EMPTY_OR_NOT_DEFINED = "dbname is empty or not defined in dbconfig.xml file, or your dbconfig.xml file is missing.";
    ...
    /**
     * the version in dbconfig.xml is earlier than the current version.
     */
    public static final String VERSION_IS_EARLIER_THAN_CURRENT = "the version in dbconfig.xml is earlier than the current version";
