 ...
 * dbconfig.xml file, ParseConfigurationFileException will be thrown.
 *
 * @author Tony Green
 * @since 1.0
 */
public class ParseConfigurationFileException extends RuntimeException {
    ...
    /**
     * can not find the dbconfig.xml file by the given id.
     */
    public static final String CAN_NOT_FIND_LITEPAL_FILE = "dbconfig.xml file is missing. Please ensure it under assets folder.";

    /**
     * can not parse the dbconfig.xml, check if it's in correct format.
     */
    public static final String FILE_FORMAT_IS_NOT_CORRECT = "can not parse the dbconfig.xml, check if it's in correct format";
