...
import kit.LogKit;
import litepal.exceptions.InvalidAttributesException;
...
/**
 * The object model for the dbconfig.xml file. Once database connection happens,
 * LitePal will try to analysis the dbconfig.xml, and read all the attribute into
...
public final class LitePalAttr {
    ...
    private static void loadLitePalXMLConfiguration() {
        if (BaseUtility.isLitePalXMLExists()) {
            ...
            litePalAttr.setAfterUpgrade(config.getAfterUpgrade());
        }
    }
