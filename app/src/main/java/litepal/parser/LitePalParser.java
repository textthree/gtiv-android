...
import litepal.parser.LitePalContentHandler;
...
/**
 * The class is used to parse the dbconfig.xml file. There're three usual ways to
...
public class LitePalParser {
     ...
     * Node name column storage.
     */
    static final String NODE_AFTER_UPGRADE = "afterUpgrade";

    /**
     * Store the parsed value of dbconfig.xml.
     */
    private static LitePalParser parser;

    /**
     * Analyze dbconfig.xml, and store the analyzed result in LitePalParser. Use
     ...
     */
    public static litepal.parser.LitePalConfig parseLitePalConfiguration() {
        if (parser == null) {
    ...
    /**
     * Use SAXParser to parse the dbconfig.xml file. It will get the parsed
     * result from LitePalContentHandler and stored in the instance of
     * LitePalAttr.
     * <p>
     * Note while analyzing dbconfig.xml file, ParseConfigurationFileException
     * could be thrown. Be careful of writing dbconfig.xml file, or developer's
    ...
    /**
     * Use XmlPullParser to parse the dbconfig.xml file. It will store the result
     ...
     * application may be crash.
     */
    private litepal.parser.LitePalConfig usePullParse() {
        try {
            litepal.parser.LitePalConfig litePalConfig = new LitePalConfig();
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                switch (eventType) {
                    case XmlPullParser.START_TAG: {
                        ...
                        } else if (nodeName.equals(NODE_AFTER_UPGRADE)) {
                            String storage = xmlPullParser.getAttributeValue("", ATTR_CLASS);
                            litePalConfig.setAfterUpgrade(storage);
                        }
                        break;
                    }
                    default:
    ...
    /**
     * Iterates all files in the root of assets folder. If find dbconfig.xml,
     * open this file and return the input stream. Or throw
     * ParseConfigurationFileException.
     *
     * @return The input stream of dbconfig.xml.
     * @throws IOException
     */
