...
/**
 * AfterUpgrade the associations between model classes into tables. Creating new
 * tables and adding new foreign key columns are done in
 * {@link litepal.tablemanager.AssociationUpdater}. So this class just deal with the simple job of
 * removing foreign key columns and dropping dump intermediate join tables.
 *
 * @author Tony Green
 * @since 1.0
 */
public abstract class AssociationUpdater extends litepal.tablemanager.Creator {
    ...
    /**
     * {@link litepal.tablemanager.AssociationUpdater} does two jobs. Removing foreign key columns
