...
/**
 * AfterUpgrade the database. The first step is to remove the columns that can not
...
public class Upgrader extends AssociationUpdater {
    ...
    /**
     * AfterUpgrade table actions. Include remove dump columns, add new columns and
