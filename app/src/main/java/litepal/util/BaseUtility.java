...
public class BaseUtility {
    ...
    public static String changeCase(String string) {
        if (string != null) {
            ...
            if (litepal.util.Const.Config.CASES_KEEP.equals(cases)) {
                return string;
            } else if (litepal.util.Const.Config.CASES_UPPER.equals(cases)) {
    ...
    /**
     * If the dbconfig.xml configuration file exists.
     *
