...
public class IjkMediaFormat implements IMediaFormat {
    // UserHelpers
    public static final String KEY_IJK_CODEC_LONG_NAME_UI = "ijk-codec-long-name-page";
    public static final String KEY_IJK_CODEC_NAME_UI = "ijk-codec-name-page";
    public static final String KEY_IJK_BIT_RATE_UI = "ijk-bit-rate-page";

    // VideosApi
    public static final String KEY_IJK_CODEC_PROFILE_LEVEL_UI = "ijk-profile-level-page";
    public static final String KEY_IJK_CODEC_PIXEL_FORMAT_UI = "ijk-pixel-format-page";
    public static final String KEY_IJK_RESOLUTION_UI = "ijk-resolution-page";
    public static final String KEY_IJK_FRAME_RATE_UI = "ijk-frame-rate-page";

    // Audio
    public static final String KEY_IJK_SAMPLE_RATE_UI = "ijk-sample-rate-page";
    public static final String KEY_IJK_CHANNEL_UI = "ijk-channel-page";
